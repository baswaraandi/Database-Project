...
<form action="" method="Post">
    ...
    <div class="Form-content-style">
          <input type="text" name="Id_Transaksi"  value="<?php echo $i; ?>">
      </div>
      <div class="Form-content-style">
      ...
      <div class="Form-content-style">
          <input type="submit" name="up" value="Edit Data"
...
if(isset($_POST['up']))
{
    ...
    $i = $_POST ['Id_Transaksi'];
    $idst = $_POST ['Id_Store'];
    $nb = $_POST ['Nama_Buyer'];
    $tt = $_POST ['Tgl_Transaksi'];
    mysqli_query($con,"update transaksi set Id_Store = '$idst', Nama_Buyer = '$nb', Tgl_Transaksi = '$tt' where Id_Transaksi ='$i'");
...
<tbody>
    <tr>
        ...
        <td><a class="text-remove" href = "deletetransaksi.php?i=<?php echo $r['Id_Stock']; ?>">Remove</a></td>
        <td><a class="text-update" href = "updatetransaksi.php?i=<?php echo $r['Id_Stock']; ?>">Update</a></td>
    </tr>
</tbody>
<?php
}
